...
<body class = "min-vh-100">
    <header class = "bg-warning d-flex flex-row mw-100 p-3">
        <img src="{{ asset('storage/logoDYID.png') }}" alt="" height=50px class = "px-2">
    ...
    <nav class = "bg-primary d-flex flex-row align-items-center justify-content-between mw-100 p-3">
        ...
        <div class = "d-flex flex-row justify-content-center align-items-center">
            <button class = "btn btn-primary border mx-1">Login</button>
            <button class = "btn btn-primary border mx-1">Register</button>
        </div>
    </nav>
    <main class = "h-auto">
        @yield('content')
