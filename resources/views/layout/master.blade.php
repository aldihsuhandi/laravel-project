...
<body class = "min-vh-100 d-flex flex-column bg-secondary">
    <header class = "bg-warning d-flex flex-row mw-100 p-3">
        ...
        <form action="/search" method = "post" class = "form-horizontal d-flex flex-row w-75">
            @csrf
            <input type="text" name="search" class="form-control rounded w-100" placeholder="Search" aria-label="Search">
    ...
    <nav class = "bg-primary d-flex flex-row align-items-center justify-content-between mw-100 p-3">
        <div class = "d-flex flex-row align-items-center">
            ...
            @if (Auth::check() && Auth::user() -> role -> role == "Member")
                ...
                <a href="/transaction" class = "px-2 text-white text-decoration-none">History Transaction</a>
    ...
    <footer class = "mt-auto d-flex flex-column justify-content-center align-items-center bg-primary p-3">
        <div class = "d-flex flex-row justify-content-evenly w-50 my-1">
            <a href = "https://www.youtube.com/watch?v=dQw4w9WgXcQ" class = "fab text-decoration-none fa-facebook-f text-white"></a>
            <a href = "https://www.youtube.com/watch?v=dQw4w9WgXcQ" class = "fab text-decoration-none fa-twitter text-white"></a>
            <a href = "https://www.youtube.com/watch?v=dQw4w9WgXcQ" class = "fab text-decoration-none fa-instagram text-white"></a>
        </div>
